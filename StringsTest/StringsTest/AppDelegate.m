...
//    NSLog(@"%@", text);
    ...
    NSLog(@"array's count is: %d", [array count]);
    NSLog(@"%@", array);
...
- (void) stringRange:(NSString*) string searchPattern:(NSString*) pattern {
